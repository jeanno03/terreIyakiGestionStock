...
public class DataCreerAction extends Action{
	...
	public ActionForward execute(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequete,
		...
		try {
		generation.getData();
		pRequete.setAttribute("message", "Le jeu d'essai a été créé");
		}catch(NullPointerException ex) {
			pRequete.setAttribute("message", "Echec affichage liste utilisateur");
