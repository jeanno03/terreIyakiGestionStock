...
public class ProductAfficherTerreIyakiProductListByFreshProductAction extends Action{
	...
	public ActionForward execute(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequete,
		...
		List<TerreIyakiProduct> te01 = productTreatment.getTerreIyakiProductListByFreshProduct(name);

		pRequete.setAttribute("nomChoisi", name);
		pRequete.setAttribute("TerreIyakiProductChoice", te01);
